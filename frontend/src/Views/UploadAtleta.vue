          ...
          <div class="card-body p-4">
            ...
            <form @submit.prevent="createAtleta">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="dni" v-model.number="nuevoAtleta.dni"
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nombre" v-model="nuevoAtleta.nombre"
                  placeholder="Ej: Juan Pérez">
              </div>

              <div class="mb-3">
                <label for="tiempo" class="form-label fw-semibold">Tiempo (hh:mm:ss)</label>
                <input type="text" class="form-control" id="tiempo" v-model="nuevoAtleta.tiempo"
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="posicion" v-model.number="nuevoAtleta.posicion" min="1"
                  placeholder="Ej: 1">
              </div>

              <div class="mb-4">
                <label for="ciudadId" class="form-label fw-semibold">Ciudad</label>
                <select class="form-select" id="ciudadId" v-model.number="nuevoAtleta.ciudadId">
